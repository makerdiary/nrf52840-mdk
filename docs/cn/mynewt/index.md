...
[![](../../mynewt/images/mynewt-logo.png)](http://mynewt.apache.org)
...
!!! note "提示"
    nRF52840-MDK 硬件支持 OpenOCD 调试器，Mynewt 使用 OpenOCD 来下载固件和调试，可以按照以下链接指引完成安装：[OpenOCD 安装指引](https://mynewt.apache.org/latest/os/get_started/cross_tools/#installing-openocd-on-mac-os)。
...
![](../../mynewt/images/mynewt_blinky_demo.gif)
...
我们已经为 nRF52840-MDK 提供 Mynewt 板级支持包 [mynewt_nrf52840_mdk](https://github.com/makerdiary/mynewt_nrf52840_mdk)，可以在 `project.yml` 项目配置文件中进行配置：
...
随着 Mynewt 功能不断丰富，我们会不断增加一些新的应用示例到 [nrf52840-mdk](https://github.com/makerdiary/nrf52840-mdk) 仓库，你可以在 `nrf52840-mdk/examples/mynewt/` 目录找到这些示例代码。
